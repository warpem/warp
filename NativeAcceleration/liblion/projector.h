...
#define ACT_ON_WEIGHT 1
	...
	public:
		...
		*
		*/
		void computeFourierTransformMap(MultidimArray<DOUBLE> &vol_in, float* vol_out, int current_size = -1, int nr_threads = 1, bool do_gridding = true, bool do_statistics = true, bool output_centered = true);
